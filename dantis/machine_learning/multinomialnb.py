from sklearn.naive_bayes import MultinomialNB as multinomial
import numpy as np
...
class MultinomialNB(algorithmbase.AlgorithmBase):
    """
    MultinomialNB(hyperparameter: dict)

    A supervised anomaly detection classifier using Multinomial Naive Bayes.
    This wrapper is designed for categorical or count-based data (e.g., bag-of-words).
    ...
    ----------
    hyperparameter : dict
        Dictionary containing hyperparameters for the MultinomialNB model.

    Attributes
    ----------
    _model : multinomial
        Instance of scikit-learn's MultinomialNB.
    ...
    def __init__(self, hyperparameter: dict):
        """
        Initialize the MultinomialNB model with the given hyperparameters.
    ...
    def save_model(self, path_model: str):
        """
        Save the trained MultinomialNB model to disk.
    ...
    def load_model(self, path_model: str):
        """
        Load a MultinomialNB model from a saved file.
    ...
    def _create_model(self):
        """
        Instantiate the MultinomialNB model using current hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = multinomial(**self._hyperparameter)
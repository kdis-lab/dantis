...
class LMDD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
             Fit detector. Adjusts the LMDD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the LMDD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the LMDD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the LMDD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the LMDD model with the provided hyperparameters.
        """

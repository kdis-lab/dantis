...
class CBLOF(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the CBLOF model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the CBLOF model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the CBLOF model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the CBLOF model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the CBLOF model with the provided hyperparameters.
        """

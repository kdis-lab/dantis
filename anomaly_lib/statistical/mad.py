...
class MAD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the MAD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the MAD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the MAD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the MAD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the MAD model with the provided hyperparameters.
        """

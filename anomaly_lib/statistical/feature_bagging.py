...
class FeatureBagging(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            Feature Bagging class constructor.

            Args:
                - hyperparameters (dict): a dictionary containing the hyperparameters
                  for the Feature Bagging algorithm.
    ...
    def fit(self):
        """
            Fit detector. Adjusts the Feature Bagging model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the Feature Bagging model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the Feature Bagging model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the Feature Bagging model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the Feature Bagging model with the provided hyperparameters.
        """

...
class MCD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the MCD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the MCD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the MCD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the MCD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the MCD model with the provided hyperparameters.
        """

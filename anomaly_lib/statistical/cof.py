...
class COF(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the COF model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the COF model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the COF model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the COF model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the COF model with the provided hyperparameters.
        """

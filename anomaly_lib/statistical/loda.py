...
class LODA(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the LODA model using the training data.
    ...
    def predict(self):
        """
             ...
             Adjusts the LODA model using the test data.
    ...
    def save_model(self, path_model):
        """
              Saves the LODA model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the LODA model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the LODA model with the provided hyperparameters.
        """

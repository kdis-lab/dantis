...
class KDE(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the KDE model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the KDE model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the KDE model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the KDE model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the KDE model with the provided hyperparameters.
        """

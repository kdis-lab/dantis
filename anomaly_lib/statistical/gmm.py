...
class GMM(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the GMM model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the GMM model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the GMM model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the GMM model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the GMM model with the provided hyperparameters.
        """

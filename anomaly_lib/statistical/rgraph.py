...
class RGraph(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the R-graph model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the R-graph model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the R-graph model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the R-graph model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the R-graph model with the provided hyperparameters.
        """

...
class COPOD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the COPOD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the COPOD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the COPOD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the COPOD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the COPOD model with the provided hyperparameters.
        """

...
class QMCD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the QMCD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the QMCD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the QMCD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the QMCD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the QMCD model with the provided hyperparameters.
        """

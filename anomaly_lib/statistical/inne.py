...
class INNE(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the INNE model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the INNE model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the INNE model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the INNE model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the INNE model with the provided hyperparameters.
        """

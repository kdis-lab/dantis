...
class SOD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the SOD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the SOD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the SOD model to the specified file.
    ...
    def load_model(self, path_model):
        """
             Loads the SOD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the SOD model with the provided hyperparameters.
        """

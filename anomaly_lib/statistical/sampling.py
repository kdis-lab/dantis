...
class Sampling(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the Sampling model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the Sampling model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the Sampling model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the Sampling model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the Sampling model with the provided hyperparameters.
        """

...
class ROD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the ROD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the ROD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the ROD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the ROD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the ROD model with the provided hyperparameters.
        """

...
class KPCA(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the KPCA model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the KPCA model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the KPCA model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the KPCA model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the KPCA model with the provided hyperparameters.
        """

...
class SARIMAX(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array=None, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            SARIMAX class constructor.

            Args:
                - hyperparameters (dict): A dictionary containing the hyperparameters for the SARIMAX algorithm.
                - x_train (np.array): Characteristics of the training data. The SARIMAX implementation may receive the
    ...
    def fit(self):
        """
              Fit detector. Adjusts the SARIMAX model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the SARIMAX model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the SARIMAX model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the SARIMAX model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the SARIMAX model with the provided hyperparameters.
        """

...
class CD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the CD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the CD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the CD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the CD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the CD model with the provided hyperparameters.
        """

...
class HBOS(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
             Fit detector. Adjusts the HBOS model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the HBOS model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the HBOS model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the HBOS model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the HBOS model with the provided hyperparameters.
        """

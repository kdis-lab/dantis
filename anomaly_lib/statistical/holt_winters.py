...
class HoltWinters(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array=None, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            Holt Winters class constructor.

            Args:
                - hyperparameters (dict): A dictionary containing the hyperparameters for the Holt Winters algorithm.
                - x_train (np.array): Characteristics of the training data. The Holt Winters implementation may receive the
    ...
    def fit(self):
        """
            Fit detector. Adjusts the Holt Winters model using the training data.
    ...
    def predict(self):
        """
             ...
             Adjusts the Holt Winters model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the Holt Winters model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the Holt Winters model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the Holt Winters model with the provided hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = holtwinters.Holt(**self._hyperparameter)
...
class SOS(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the SOS model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the SOS model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the SOS model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the SOS model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the SOS model with the provided hyperparameters.
        """

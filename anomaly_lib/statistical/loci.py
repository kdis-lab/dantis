...
class LOCI(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the LOCI model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the LOCI model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the LOCI model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the LOCI model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the LOCI model with the provided hyperparameters.
        """

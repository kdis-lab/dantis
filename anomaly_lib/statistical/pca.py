...
class PCA(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the PCA model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the PCA model using the test data.
    ...
    def save_model(self, path_model):
        """
             Saves the PCA model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the PCA model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the PCA model with the provided hyperparameters.
        """

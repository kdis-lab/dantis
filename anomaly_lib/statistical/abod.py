...
class ABOD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the ABOD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the ABOD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the ABOD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the ABOD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the ABOD model with the provided hyperparameters.
        """

...
class DecisionTreeClassifierClassOD(algorithmbase.AlgorithmBase):
    # Class Attribute
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array, x_test: np.array = None,
        ...
        """
            ...
            Args:
                - hyperparametros (dict): A dictionary containing the hyperparameters for the DecisionTreeClassifier algorithm.
    ...
    def fit(self):
        """
            Fit detector. Adjusts the DecisionTreeClassifier model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the DecisionTreeClassifier model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the DecisionTreeClassifier model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the DecisionTreeClassifier model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the DecisionTreeClassifier model with the provided hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = DecisionTreeClassifier(**self._hyperparameter)
...
class RandomForestClassOD(algorithmbase.AlgorithmBase):
    # Class Attribute
    ...
    def fit(self):
        """
            Fit detector. Adjusts the Random Forest Classifier model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the Random Forest Classifier model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the Random Forest Classifier model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the Random Forest Classifier model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the Random Forest Classifier model with the provided hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = RandomForestClassifier(**self._hyperparameter)
...
class LOF(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the LOF model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the LOF model using the test data.
    ...
    def save_model(self, path_model):
        """
             Saves the LOF model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the LOF model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the LOF model with the provided hyperparameters.
        """

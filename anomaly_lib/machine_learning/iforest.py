...
class IForest(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the IForest model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the IForest model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the IForest model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the IForest model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the IForest model with the provided hyperparameters.
        """

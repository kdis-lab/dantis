...
class GaussianNBClassOD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the Naive Bayes model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the Naive Bayes model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the Naive Bayes model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the Naive Bayes model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the Naive Bayes model with the provided hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = GaussianNB(**self._hyperparameter)
...
class ECOD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the ECOD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the ECOD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the ECOD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the ECOD model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the ECOD model with the provided hyperparameters.
        """

...
class KNN(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the KNN model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the KNN model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the KNN model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the KNN model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the KNN model with the provided hyperparameters.
        """

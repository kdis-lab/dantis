...
class MLPClassOD(algorithmbase.AlgorithmBase):
    # Class Attribute
    ...
    def fit(self):
        """
            Fit detector. Adjusts the MLP model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the MLP model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the MLP model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the MLP model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the MLP model with the provided hyperparameters.
        """
        self.set_hyperparameter(self._hyperparameter)
        self._model = MLPClassifier(**self._hyperparameter)
...
class OCSVM(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
             Fit detector. Adjusts the OCSVM model using the training data.

             Returns:
                  The outlier scores of the training data [0,1].

         """
        # check_parameter -> sample_weight
        hyperparameter = self.get_hyperparameter()
        sample_weight = None if "sample_weight" not in hyperparameter.keys() else hyperparameter["sample_weight"]
        self._model.fit(self._x_train, sample_weight=sample_weight)
    ...
    def predict(self):
        """
              ...
              Adjusts the OCSVM model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the OCSVM model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the OCSVM model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the OCSVM model with the provided hyperparameters.
        """

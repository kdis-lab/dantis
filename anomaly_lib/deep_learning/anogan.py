...
class AnoGAN(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            AnoGAN class constructor.

            Args:
                - hyperparametros (dict): A dictionary containing the hyperparameters for the AnoGAN algorithm.
    ...
    def fit(self):
        """
            Fit detector. It fits the AnoGAN model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the AnoGAN model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the AnoGAN model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the AnoGAN model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the AnoGAN model with the provided hyperparameters.
        """

...
class AutoEncoder(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            ...
            Args:
                - hyperparametros (dict): A dictionary containing the hyperparameters for the AutoEncoder algorithm.
    ...
    def fit(self):
        """
            Fit detector. Adjusts the AutoEncoder model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the AutoEncoder model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the AutoEncoder model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the AutoEncoder model from the specified file.
    ...
    def _create_model(self):
        """
            Creates the AutoEncoder model with the provided hyperparameters.
        """

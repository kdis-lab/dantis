...
class DeepSVDD(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            DeepSVDD class constructor.

            Args:
                - hyperparametros (dict): A dictionary that contains the hyperparameters for the DeepSVDD algorithm.
    ...
    def fit(self):
        """
            Fit detector. It adjusts the DeepSVDD model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the DeepSVDD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the DeepSVDD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the DeepSVDD model from the specified file.

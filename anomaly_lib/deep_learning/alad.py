...
class ALAD(algorithmbase.AlgorithmBase):
    ...
    def fit(self):
        """
            Fit detector. Adjusts the ALAD model using the training data.
        ...
        self._model.fit(self._x_train, noise_std=noise_std)
    ...
    def predict(self):
        """
            ...
            Adjusts the ALAD model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the ALAD model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the ALAD model from the specified file.

...
class SO_GAAL(algorithmbase.AlgorithmBase):
    ...
    def __init__(self, hyperparameter: dict, x_train: np.array, y_train: np.array = None, x_test: np.array = None,
        ...
        """
            SO_GAAL class constructor.

            Args:
                - hyperparametros (dict): A dictionary containing the hyperparameters for the SO_GAAL algorithm.
    ...
    def fit(self):
        """
            Fit detector. Adjusts the SO_GAAL model using the training data.
    ...
    def predict(self):
        """
            ...
            Adjusts the SO_GAAL model using the test data.
    ...
    def save_model(self, path_model):
        """
            Saves the SO_GAAL model to the specified file.
    ...
    def load_model(self, path_model):
        """
            Loads the SO_GAAL model from the specified file.
